      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-8 border-b border-zinc-900">
          ...
          <div className="md:col-span-4 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display font-black text-white text-sm">yiouapp.com</span>
            </div>
        ...
        <div className="p-4 bg-zinc-900/40 border border-zinc-900/60 rounded-xl space-y-2">
          <p className="leading-relaxed text-[11px] text-zinc-650">
            {isHant 
              ? "數字資產投資（加密貨幣/合約槓桿）含有高波動與高風險。本站 yiouapp.com 僅作為第三方獨立信息與粉絲指南頁提供內容整理，不提供交易、登錄、充值、提現、託管或帳戶服務，也不會要求您在本站輸入帳號密碼、驗證碼、助記詞或資金信息。市場有風險，請自行判斷。"
              : "数字资产投资（加密货币/合约杠杆）含有高波动与高风险。本站 yiouapp.com 仅作为第三方独立信息与粉丝指南页提供内容整理，不提供交易、登录、充值、提现、托管或账户服务，也不会要求您在本站输入账号密码、验证码、助记词或资金信息。市场有风险，请自行判断。"}
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-zinc-600">
          <div>
            <p>
              ...
              <span>yiouapp.com</span>. All rights reserved.
            </p>
          </div>
